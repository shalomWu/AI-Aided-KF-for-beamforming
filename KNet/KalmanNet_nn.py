...
class KalmanNetNN(torch.nn.Module):
    ...
    def InitKGainNet(self, prior_Q, prior_Sigma, prior_S, args):
        ...
        # GRU to track Q
        self.d_input_Q = self.m * args.in_mult_KNet #need to change to be 1
        print("Mult_Knet:", self.d_input_Q)
        ...
        self.d_hidden_FC2 = self.d_input_FC2 * args.out_mult_KNet # change to 1.
